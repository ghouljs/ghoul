...
/******/ 	var hotCurrentHash = "3feb503663d400bf62b9"; // eslint-disable-line no-unused-vars
...
var _updateRule = __webpack_require__(70);
...
var patch_1 = __webpack_require__(62);
...
function setProps(element, key, value, oldValue, isSVG) {
    ...
    if (key === 'key' || key === 'children') {
        ...
        for (var i in Object.assign({}, oldValue, value)) {
            if (typeof i === 'string') {
        ...
        // event listener
        if (value && element[key.toLowerCase()] == null) {
            element[key.toLowerCase()] = typeof value === 'function' ? value : noop;
        }
        else if (value == null) {
...
function createElement(node, isSVG) {
    if (typeof node === 'string') {
        ...
        var element = (isSVG = (node.tag === 'svg' || isSVG))
        ...
        // 2 children
        for (var _i = 0, _a = node.attributes.children; _i < _a.length; _i++) {
            var childNode = _a[_i];
...
function updateElement(element, props, nextProps) {
    for (var key in Object.assign({}, props, nextProps)) {
        var nextValue = nextProps[key];
        var value = ['value', 'checked'].indexOf(key) !== -1 ? element[key] : props[key];
...
var _jssPresetDefault = __webpack_require__(84);
...
var PageStyle = _jss2.default.createStyleSheet({
  root: {
    position: 'absolute',
    top: 0,
    left: 0,
...
var _jss$createStyleSheet = _jss2.default.createStyleSheet({
  ...
  desciption: {
    ...
    cardClasses = _jss$createStyleSheet.classes;

var _jss$createStyleSheet2 = _jss2.default.createStyleSheet((_jss$createStyleSheet3 = {
  fixed: {
    position: 'fixed',
    top: 0,
    left: 0,
...
}, _defineProperty(_jss$createStyleSheet3, '@keyframes rotates', {
  to: {
    transform: 'rotate(1turn)'
  }
}), _defineProperty(_jss$createStyleSheet3, '@keyframes dash', {
  '0%': {
...
}), _defineProperty(_jss$createStyleSheet3, 'loading', {
  width: '3rem',
  height: '3rem',
  animation: 'rotates 2s linear infinite'
}), _defineProperty(_jss$createStyleSheet3, 'circle', {
  stroke: 'rgba(224, 224, 224, 1)',
  animation: 'dash 1.5s ease-in-out infinite'
}), _defineProperty(_jss$createStyleSheet3, '@keyframes fadeAndSlideInUp', {
  '0%': {
    opacity: 0,
...
}), _defineProperty(_jss$createStyleSheet3, 'btns', {
  fontSize: '.85rem',
  position: 'fixed',
  right: '1rem',
  bottom: '1rem',
  color: 'rgba(0, 0, 0, .78)'
}), _defineProperty(_jss$createStyleSheet3, 'btn', {
  marginTop: '.5rem',
  height: '40px',
  width: '40px',
  borderRadius: '50%',
  ...
  padding: 6,
  overflow: 'hidden'
}), _defineProperty(_jss$createStyleSheet3, 'hidden', {
  opacity: 0,
  pointerEvents: 'none'
}), _jss$createStyleSheet3)).attach(),
    commonClasses = _jss$createStyleSheet2.classes;
...
var Page = function Page(_ref) {
  ...
  return (0, _lib.h)(
    'div',
    { className: PageStyle.classes.root },
    children
  );
};
...
var Avatar = function Avatar(_ref2) {
  var src = _ref2.src;
  return (0, _lib.h)('img', { src: src, className: cardClasses.avatar });
};
...
var Star = function Star(_ref4) {
  ...
  return (0, _lib.h)(
    'span',
    { className: cardClasses.star },
    count
  );
};

var Fork = function Fork(_ref5) {
  var count = _ref5.count;
  return (0, _lib.h)(
    'span',
    { className: cardClasses.fork },
    count
  );
};

var Divide = function Divide() {
  return (0, _lib.h)('div', { className: cardClasses.divide });
};

var Desciption = function Desciption(_ref6) {
  var children = _ref6.children;
  return (0, _lib.h)(
    'div',
    { className: cardClasses.desciption },
    children
  );
};
...
var Card = function Card(_ref8) {
  var key = _ref8.key,
      ...
      star = _ref8.star,
      fork = _ref8.fork,
      desciption = _ref8.desciption;
  return (0, _lib.h)(
    'a',
    { key: key, className: cardClasses.outer, href: link },
    (0, _lib.h)(
      'div',
      { style: style, className: [cardClasses.container, className].join(' ') },
      (0, _lib.h)(
        'div',
        { className: cardClasses.top },
        (0, _lib.h)(Avatar, { src: avatar }),
        (0, _lib.h)(
          'div',
          { className: cardClasses.simple },
          (0, _lib.h)(Title, { text: repo }),
          (0, _lib.h)(
            'div',
            { className: cardClasses.counter },
            (0, _lib.h)(
              'div',
              { style: { flex: 1 } },
              (0, _lib.h)(Icon, { name: 'star' }),
              (0, _lib.h)(Star, { count: star })
            ),
            (0, _lib.h)(
              'div',
              { style: { flex: 1 } },
              (0, _lib.h)(Icon, { name: 'fork' }),
              (0, _lib.h)(Fork, { count: fork })
            )
          )
        )
      ),
      (0, _lib.h)(Divide, null),
      (0, _lib.h)(
        Desciption,
        null,
        desciption
...
var SyncButton = function SyncButton(_ref9) {
  var active = _ref9.active,
      _ref9$menus = _ref9.menus,
      menus = _ref9$menus === undefined ? [] : _ref9$menus,
      onOpen = _ref9.onOpen,
      onSelect = _ref9.onSelect,
      others = _objectWithoutProperties(_ref9, ['active', 'menus', 'onOpen', 'onSelect']);
  ...
  return (0, _lib.h)(
    ...
    (0, _lib.h)(
      'div',
      { className: !active ? commonClasses.hidden : '' },
      menus.map(function (e, i) {
        return (0, _lib.h)(
          'div',
          {
            key: e.key,
...
var Loading = function Loading(_ref11) {
  var active = _ref11.active;
  return (0, _lib.h)(
    'div',
    null,
    (0, _lib.h)(Mask, { active: active }),
    (0, _lib.h)(
      'div',
      { className: [commonClasses.fixed, commonClasses.center, active ? '' : commonClasses.noMask].join(' ') },
      (0, _lib.h)(Loader, null)
    )
  );
};
...
(0, _lib2.default)({
  ...
  view: function view(state, action, effect) {
    return (0, _lib.h)(
      Page,
      null,
      (0, _values2.default)(state.data).map(function (e, i) {
        return (0, _lib.h)(Card, _extends({}, e, {
          className: 'animated',
      ...
      (0, _lib.h)(SyncButton, {
        ...
        onOpen: function onOpen() {
          return action('switch/menu/status');
        },
        onSelect: function onSelect(lang) {
          return effect('sync', lang);
        }
      }),
      (0, _lib.h)(Loading, { active: state.loading })
    );
  },
  actions: {
    save: function save(state, data) {
      return { data: data /* Object.assign({}, state.data, data) */ };
    },
    'sync/start': function syncStart() {
      return { loading: true };
    },
    'sync/end': function syncEnd() {
      return { loading: false };
    },
    'switch/menu/status': function switchMenuStatus(state) {
      return { menusActive: !state.menusActive };
    }
  },
  effects: {
    sync: function sync(_ref12, lang) {
      var action = _ref12.action;

      action('sync/start');

      fetch('https://trending-api-github.herokuapp.com/api/repo/' + lang + '/?since=daily').then(function (res) {
        return res.json();
      }).then(function (r) {
        return r.data;
      }).then(function (e) {
        return e.reduce(function (a, b) {
          return (0, _assign2.default)(a, _defineProperty({}, b.repo, (0, _assign2.default)({}, b, {
            key: b.repo,
            repo: b.repo.slice(1),
            link: b.repo_link,
            avatar: b.avatars[0],
...
Object.defineProperty(exports, "__esModule", { value: true });
var vdom_1 = __webpack_require__(19);
exports.patch = vdom_1.patch;
var h_1 = __webpack_require__(63);
exports.h = h_1.h;
var ghoul_1 = __webpack_require__(64);
exports.default = ghoul_1.ghoul;
...
function patch(parent, element, oldNode, node) {
    if (oldNode === node) {
        ...
        element = parent.insertBefore(utils_1.createElement(node), element);
    }
    else if (node.tag != null && node.tag === oldNode.tag) {
        utils_1.updateElement(element, oldNode.attributes, node.attributes);
        var oldElements = [];
        var reusableChildren = {};
        for (var i_1 in oldNode.attributes.children) {
            var oldChildNode = oldNode.attributes.children[i_1];
            var oldElement = element.childNodes[i_1];
            oldElements[i_1] = oldElement;
            var key = utils_1.getKey(oldChildNode);
            if (null != key) {
        ...
        while (j < node.attributes.children.length) {
            var oldChildNode = oldNode.attributes.children[i];
            var oldKey = utils_1.getKey(oldChildNode);
            if (usedKeys[oldKey]) {
                i++;
                continue;
            }
            var oldElement = oldElements[i];
            var newChildNode = node.attributes.children[j];
            var newKey = utils_1.getKey(newChildNode);
            if (null == newKey) {
                if (null == oldKey) {
                    patch(element, oldElement, oldChildNode, newChildNode);
                    j++;
                }
                i++;
            }
            else {
                var _a = reusableChildren[newKey] || {}, _b = _a.oldElement, reusableElement = _b === void 0 ? null : _b, _c = _a.oldNode, reusableNode = _c === void 0 ? null : _c;
                // remove usedChildren;
                delete reusableChildren[newKey];
                if (oldKey === newKey) {
                    patch(element, reusableElement, reusableNode, newChildNode);
                }
                    ...
                    patch(element, oldElement, null, newChildNode);
                }
        ...
        while (i < oldNode.attributes.children.length) {
            var key = utils_1.getKey(oldNode.attributes.children[i]);
            if (null == key || (key && !usedKeys[key])) {
                var oldChildNode = oldNode.attributes.children[i];
                utils_1.removeElement(element, oldElements[i], oldChildNode.attributes);
            }
            i++;
        }
        for (var k in reusableChildren) {
            if (!usedKeys[k]) {
                utils_1.removeElement(element, reusableChildren[k].oldElement, reusableChildren[k].oldNode.attributes);
            }
        }
    }
    else if (element && element.nodeValue !== node) {
        if (typeof oldNode === 'string' && typeof node === 'string') {
            element.nodeValue = node;
        }
        else {
            var newElment = parent.insertBefore(utils_1.createElement(node), element);
            utils_1.removeElement(parent, element, oldNode.attributes);
            element = newElment;
        }
    }
    return element;
...
function h(tag, attributes) {
    ...
    var node;
    var simple, lastSimple;
    var children = [];
    for (var i = arguments.length; i >= 2; i -= 1) {
    ...
    return typeof tag === 'string'
        ? { tag: tag, attributes: __assign({}, attributes, { children: children }) }
        : tag(__assign({}, attributes, { children: children, _component: tag.name || tag.displayName }));
}
exports.h = h;
...
function ghoul(props) {
    ...
    var effects = {};
    var subscriptions = {};
    var el = props.root || document.body;
    var element;
    var oldNode;
    init();
    function init() {
    ...
    function render() {
        element = vdom_1.patch(el, element, oldNode, (oldNode = view(state, action, effect)));
    }
    function action(type) {
        ...
        return actions[type].apply(actions, args);
    }
    function effect(type) {
        ...
        return effects[type].apply(effects, args);
    }
    function Action(actionFn, next) {
        return function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            var updatedState = actionFn.apply(void 0, [state].concat(args));
            if (typeof updatedState === 'function') {
                updatedState();
            }
            else {
                var currentState_1 = __assign({}, state, updatedState);
                // shallow compare state (@TODO) on top root, to reduce render
                if (Object.keys(state).length === Object.keys(currentState_1).length
                    && Object.keys(state).every(function (k) { return state[k] === currentState_1[k]; }))
                    return;
                state = currentState_1;
    ...
    function Effect(effectFn) {
        return function () {
            ...
            return new Promise(function (resolve) { return effectFn.apply(void 0, [{ state: state, action: action, effect: effect, next: resolve }].concat(args)); });
        };
    }
    function Subscription(subscriber) {
        return function () {
            ...
            return subscriber({ state: state, action: action, effect: effect });
        };
    }
    function runSubscriptions() {
        Object.keys(subscriptions).map(function (e) { return subscriptions[e]; }).forEach(function (e) { return e(); });
    }
}
exports.ghoul = ghoul;
...
var _PluginsRegistry = __webpack_require__(73);
...
var _createGenerateClassName = __webpack_require__(80);
...
var _findRenderer = __webpack_require__(81);
...
var _SimpleRule = __webpack_require__(75);

var _SimpleRule2 = _interopRequireDefault(_SimpleRule);

var _KeyframesRule = __webpack_require__(76);
...
var _ViewportRule = __webpack_require__(79);
...
var _DomRenderer = __webpack_require__(82);

var _DomRenderer2 = _interopRequireDefault(_DomRenderer);

var _VirtualRenderer = __webpack_require__(83);
...
var _jssExtend = __webpack_require__(85);

var _jssExtend2 = _interopRequireDefault(_jssExtend);

var _jssNested = __webpack_require__(86);

var _jssNested2 = _interopRequireDefault(_jssNested);

var _jssCamelCase = __webpack_require__(87);

var _jssCamelCase2 = _interopRequireDefault(_jssCamelCase);

var _jssDefaultUnit = __webpack_require__(88);

var _jssDefaultUnit2 = _interopRequireDefault(_jssDefaultUnit);

var _jssVendorPrefixer = __webpack_require__(90);

var _jssVendorPrefixer2 = _interopRequireDefault(_jssVendorPrefixer);

var _jssPropsSort = __webpack_require__(95);

var _jssPropsSort2 = _interopRequireDefault(_jssPropsSort);

var _jssCompose = __webpack_require__(96);

var _jssCompose2 = _interopRequireDefault(_jssCompose);

var _jssExpand = __webpack_require__(97);

var _jssExpand2 = _interopRequireDefault(_jssExpand);

var _jssGlobal = __webpack_require__(99);
...
var _defaultUnits = __webpack_require__(89);
...
var _cssVendor = __webpack_require__(91);
...
var _supportedProperty = __webpack_require__(92);

var _supportedProperty2 = _interopRequireDefault(_supportedProperty);

var _supportedValue = __webpack_require__(94);
